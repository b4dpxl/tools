...
""", formatter_class=argparse.RawTextHelpFormatter )
    ...
    parser.add_argument( "--output", dest="output", default="txt", help="Output format", choices=[ "txt", "csv" ] )
    ...
    themes = {
        ...
        "Day": [ "monday", "tuesday", "wednesday", "thursday", "friday", "saturday", "sunday", "today", "tomorrow", "yesterday" ]
    }
